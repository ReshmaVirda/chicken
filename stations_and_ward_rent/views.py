...
class DetailView(APIView):
    ...
    def get(self, request, id, format=None):
        try:
            product_feed = StationAndWard.objects.get(id=id)
        except:
            return Response(
                {
                    "success": False,
        ...
        serializer = StationAndWardSerializer(product_feed)
...
class ListView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        products = StationAndWard.objects.filter()
        return products
...
class UpdateView(APIView):
    ...
    def put(self, request, id, format=None):
        ...
        serializer = StationAndWardSerializer(product_feed, data=request.data)
        if serializer.is_valid():
            serializer.save()
...
class DeleteView(APIView):
    ...
    def delete(self, request, id, format=None):
        ...
        return Response(
            {
                "success": True,
                "message": "StationAndWard deleted Successfully",
                "data": [],
            },
